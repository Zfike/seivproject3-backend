...
// Accommodation Categories and Accommodations
db.accommodationCategory.hasMany(db.accommodation, { foreignKey: 'accommodationCategoryId', onDelete: 'CASCADE' });
db.accommodation.belongsTo(db.accommodationCategory, { foreignKey: 'accommodationCategoryId', onDelete: 'CASCADE' });

// Accommodation Categories and UserAccommodations
...
// Semesters and User Accommodation Requests
db.semester.hasMany(db.userAccommodationRequest, { foreignKey: 'semesterId', onDelete: 'CASCADE' });
db.userAccommodationRequest.belongsTo(db.semester, { foreignKey: 'semesterId', onDelete: 'CASCADE' });
